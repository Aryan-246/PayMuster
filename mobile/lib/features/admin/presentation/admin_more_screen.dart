      ...
      body: ListView(
        ...
        children: [
          ...
          _buildMenuTile(
            ...
            title: 'Owners',
            subtitle: 'Owner directory, companies & subscription access',
            route: '/admin/owners',
            surfaceColor: surfaceColor,
            textColor: textColor,
          ),
          const SizedBox(height: AdminSpacing.lg),
          const AdminSectionHeader(title: 'Growth & Revenue'),
          const SizedBox(height: AdminSpacing.sm),
          _buildMenuTile(
            context,
            icon: Icons.card_membership_outlined,
            title: 'Subscriptions',
            subtitle: 'Subscribers, trials, unlimited access & offers',
          ...
          _buildMenuTile(
            ...
            subtitle: 'Platform payment events & provider references',
          ...
          _buildMenuTile(
            ...
            title: 'Mail Supply',
            subtitle: 'Platform email quota, history & composer',
            route: '/admin/mail',
            surfaceColor: surfaceColor,
            textColor: textColor,
          ),
          _buildMenuTile(
            ...
            title: 'Announcements',
            subtitle: 'Campaign history & acknowledgement tracking',
          ...
          _buildMenuTile(
            ...
            subtitle: 'Moderate reviews, ratings summary & responses',
            route: '/admin/reviews',
            surfaceColor: surfaceColor,
            textColor: textColor,
          ),
          _buildMenuTile(
            ...
            subtitle: '30-day platform activity from live data',
            route: '/admin/reports',
            surfaceColor: surfaceColor,
            textColor: textColor,
          ),
          ...
          _buildMenuTile(
            ...
            subtitle: 'Live status of AI, email, payment & push providers',
